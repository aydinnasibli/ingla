...
const TrainingCenterSchema = new Schema({
    ...
    course: {
        type: String,
        enum: ["Peşəkar Trener Akademiyası", "Daxili Motivasiya və Performansın Artırılması", "Region Gənclərinin Yay Düşərgəsi", "İnkişaf Akademiyası", "Təcrübəli mentorlarla fərdi görüşlər", "Masterklasslar", "Təcrübə imkanları", "Xidmət Mədəniyyəti və Müştəri Məmnuniyyəti", "Gənclərin İnkişaf Marafonu", "Komanda İdarəetməsi və Effektiv Kommunikasiya", "Karyera Məsləhətçiləri Kursu", "HR Peşəkarı", "Satış Uğurunun Sirləri", "Zamanı İdarə Etmə", "Bədən Dili və Ünsiyyət Bacarıqları", "Mindfulness: Zehni Rahatlıq və Fokuslanma", "PMP: Layihə İdarəetməsində Peşəkarlıq", "Şəxsi Brendinq və Sosial Media Strategiyaları", "Mobiliqrafiya və Vizual Kontent Yaratma"],
        required: true
    }
});
