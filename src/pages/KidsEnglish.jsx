...
function KidsEnglish() {
    return (
        <div>
            <p className='text-center text-4xl mt-10'>Kids English</p>
                        ...
                        <div className="lg:pl-[100px] flex items-center">
                            <div className="data w-full">
                                ...
                                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                    Uşaqlar üçün İngilis dili dərsləri, onların dil bacarıqlarını inkişaf etdirmək üçün xüsusi olaraq hazırlanmış proqramlardır. Bu dərslər, uşaqların yaş və səviyyələrinə uyğun şəkildə keçirilir, dilin əsas bacarıqları – danışıq, dinləmə, oxu və yazı – oyunlar, əyləncəli tapşırıqlar və interaktiv fəaliyyətlərlə öyrədilir. Uşaqların ingilis dilini öyrənərkən əylənməsi və maraqlı qalması məqsədilə müasir tədris metodları tətbiq olunur.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="data w-full">
                                ...
                                <ul className="space-y-4 text-lg text-gray-500">
                                    <li className="flex items-start">
                                        ...
                                        <span><strong>Danışıq Bacarıqları</strong> – Uşaqların gündəlik həyatda istifadə edə biləcəyi ifadələr və sözlərlə danışıq bacarıqlarını inkişaf etdiririk.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-indigo-600 mr-2">🔹</span>
                                        <span><strong>Dinləmə Bacarıqları</strong> – Sadə dialoqlar və hekayələrlə uşaqların dinləmə qabiliyyətini artırırıq.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-indigo-600 mr-2">🔹</span>
                                        <span><strong>Oxu Bacarıqları</strong> – Uşaqlara maraqlı və yaşlarına uyğun kitablar və mətnlər vasitəsilə oxu bacarıqlarını inkişaf etdiririk.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-indigo-600 mr-2">🔹</span>
                                        <span><strong>Yazı Bacarıqları</strong> – Sadə cümlələr qurmaq, şəkillərlə yazı yazmaq və söz ehtiyatını artırmaq.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-indigo-600 mr-2">🔹</span>
                                        <span><strong>Qrammatika və Lüğət</strong> – Yaşlarına uyğun qrammatik qaydalar və yeni sözləri öyrənmək.</span>
                                    </li>
                                    <li className="flex items-start">
                                        <span className="text-indigo-600 mr-2">🔹</span>
                                        <span><strong>Oyunlar və Aktivliklər</strong> – Oyunlar, rəsm və musiqi vasitəsilə dili təbii şəkildə öyrətmək.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
