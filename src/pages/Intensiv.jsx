...
function Intensiv() {
    return (
        <div >
            <p className='text-center  text-4xl mt-10'>Intensiv</p>
            <p></p>
                        ...
                        <div class="lg:pl-[100px] flex items-center">
                            <div class="data w-full">
                                ...
                                <p class="font-normal  text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                    İntensiv İngilis Dili kursları, dil öyrənmək istəyənlər üçün sürətli və effektiv həllər təqdim edir. Bu proqramlar, gündəlik dərslər və yüksək səviyyəli tədris metodları ilə tələbələrin ingilis dilində sürətlə irəliləməsini təmin edir. Qısa müddət ərzində dil bacarıqlarını inkişaf etdirmək üçün nəzərdə tutulmuş bu kurslar, həmçinin şagirdlərə real həyat vəziyyətlərində özlərini ifadə etməyə və ünsiyyət qurmağa kömək edir.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="lg:pr-24 flex items-center">
                            <div class="data w-full">
                                ...
                                <ul className="list-disc space-y-6  pl-6 text-xl text-gray-500 max-w-2xl mx-auto">
                                    <li>İntensiv İngilis Dili kursları sürətli nəticələr əldə etmək üçün tədris olunur.</li>
                                    <li>Gündəlik dərslər və intensiv məşqlər vasitəsilə dil bacarıqları sürətlə inkişaf etdirilir.</li>
                                    <li>Real həyat vəziyyətlərində ünsiyyət qurma bacarığını artırmaq üçün praktiki yanaşma tətbiq olunur.</li>
                                    <li>Təcrübəli müəllimlər və fərdi yanaşma ilə daha effektiv öyrənmə təmin edilir.</li>
                                    <li>Hər səviyyədən olan tələbələr üçün uyğun dərs proqramları mövcuddur, istənilən vaxt başlanğıc səviyyəsindən irəliləyə bilərsiniz.</li>
