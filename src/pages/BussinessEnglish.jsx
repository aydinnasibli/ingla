...
function BussinessEnglish() {
    return (
        <div >
            <p className='text-center  text-4xl mt-10'>Business English</p>
            <p></p>
                        ...
                        <div class="lg:pl-[100px] flex items-center">
                            <div class="data w-full">
                                ...
                                <p class="font-normal  text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                    Biznes İngilis dili kurslarımız peşəkar mühitdə səlis və inamlı ünsiyyət qurmaq istəyən şəxslər üçün nəzərdə tutulub. Proqramımız yazışmalar, təqdimatlar, görüşlər və danışıqlar üçün vacib olan dil bacarıqlarını inkişaf etdirməyə yönəlib. Dərslər praktiki yanaşma ilə aparılır və real iş mühitinə uyğun tapşırıqlarla dəstəklənir. Fərdi və qrup dərsləri vasitəsilə tələbələr öz biliklərini sürətlə təkmilləşdirə bilərlər.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="lg:pr-24 flex items-center">
                            <div class="data w-full">
                                ...
                                <ul className="list-disc space-y-6  pl-6 text-xl text-gray-500 max-w-2xl mx-auto">
                                    <li>Biznes mühitində inamlı və peşəkar ünsiyyət qurmaq üçün ingilis dili bacarıqlarını inkişaf etdirməyə kömək edirik.</li>
                                    <li>Rəsmi yazışmalar, təqdimatlar və iş görüşləri üçün spesifik ifadələr və üslub qaydalarını öyrədirik.</li>
                                    <li>Praktiki dərslər və real iş situasiyalarına əsaslanan tapşırıqlar vasitəsilə tələbələrin bacarıqlarını möhkəmləndiririk.</li>
                                    <li>Fərdi və qrup formatında interaktiv dərs metodlarından istifadə edərək öyrənmə prosesini daha effektiv edirik.</li>
                                    <li>Beynəlxalq iş dünyasında uğur qazanmaq üçün tələbələrə biznes ingilis dili üzrə tam dəstək göstəririk.</li>
