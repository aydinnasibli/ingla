...
import photo1 from '../assets/11ratio/IMG_8517.png'
import photo2 from '../assets/11ratio/IMG_8514.png'
function RusDili() {
    return (
        <div >
                        ...
                        <div class="lg:pl-[100px] flex items-center">
                            <div class="data w-full">
                                ...
                                <p class="font-normal  text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                    Rus dili kurslarımız tələbələrin rus dilini effektiv və praktiki şəkildə öyrənməsini təmin edir. Kurs, qrammatika, danışıq, dinləmə, oxuma və yazma bacarıqlarını inkişaf etdirmək üçün nəzərdə tutulmuşdur. Peşəkar müəllimlərimiz interaktiv dərs metodları ilə tədris apararaq, tələbələrin dili sürətli və asan mənimsəməsinə kömək edir. Həm yeni başlayanlar, həm də inkişaf səviyyəsində olanlar üçün uyğun proqramlarımız mövcuddur. Rus dili bilikləri akademik təhsil, biznes və şəxsi inkişaf üçün geniş imkanlar açır.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="lg:pr-24 flex items-center">
                            <div class="data w-full">
                                ...
                                <ul className="list-disc space-y-6  pl-6 text-xl text-gray-500 max-w-2xl mx-auto">
                                    <li>Rus dili kursumuz sizə effektiv və interaktiv şəkildə rus dilini öyrənməyə kömək edir.
                                    </li>
                                    <li>Dərslər danışıq, dinləmə, oxu, yazı və qrammatika üzrə tam tədris proqramını əhatə edir.
                                    </li>
