...
import photo1 from '../assets/11ratio/IMG_8454.png'
import photo2 from '../assets/11ratio/IMG_8455.png'
function AdaSchool() {
    return (
        <div >
            <p className='text-center  text-4xl mt-10'>Ada School</p>
            <p></p>
