...
import photo1 from '../assets/11ratio/IMG_8455.png'
import photo2 from '../assets/11ratio/IMG_8458.png'
function Almandili() {
    return (
        <div>
            <p className='text-center text-4xl mt-10'>Alman Dili </p>

            <section className="py-14 lg:py-24 relative">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
                        <div className="img-box">
                            <img src={photo1} alt="Alman Dili"
                        ...
                        <div className="lg:pl-[100px] flex items-center">
                            <div className="data w-full">
                                ...
                                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                                    Alman dilini öyrənmək istəyənlər üçün xüsusi proqramlarımız həm uşaqlar, həm də böyüklər üçün nəzərdə tutulub. Dərslər yaş qruplarına və səviyyəyə uyğun şəkildə təşkil olunur, interaktiv və praktiki metodlarla keçirilir.
                                    Uşaqlar üçün alman dili dərsləri 6-14 yaş aralığında olan şagirdlərə yönəlib. Dərslər oyunlar, mahnılar və vizual materiallar vasitəsilə öyrədilir, uşaqların söz ehtiyatını artırır və düzgün tələffüz formalaşdırır. Dinləmə, danışıq, oxu və yazı bacarıqları kompleks şəkildə inkişaf etdirilir.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-9">
                        <div className="lg:pr-24 flex items-center">
                            <div className="data w-full">
                                ...
                                <h3 className="font-bold text-3xl mb-6 max-lg:text-center">Böyüklər üçün Alman Dil dərsləri</h3>
                                <p className='font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto'>Böyüklər üçün alman dili dərsləri isə başlanğıc, orta və yüksək səviyyələri əhatə edir. Kurslar gündəlik ünsiyyət, işgüzar alman dili və akademik məqsədlər üçün xüsusi proqramlarla tədris olunur. Qrammatika, söz ehtiyatı və düzgün danışıq texnikalarına xüsusi diqqət yetirilir.
                                    Dərslər həm fərdi, həm də qrup şəklində, onlayn və əyani formada keçirilir.
                                </p>
