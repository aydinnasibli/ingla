...
import { FaRunning, FaCampground, FaUniversity, FaTimes } from "react-icons/fa";
const trainings = [
    {
        title: "Gənclərin İnkişaf Marafonu",
        plan: "Şəxsi və peşəkar inkişaf üçün intensiv marafon proqramı.",
        about: "Gənclərə liderlik, ünsiyyət və şəxsi inkişaf bacarıqlarını artırmaq üçün nəzərdə tutulmuş proqram.",
        icon: <FaRunning className="text-red-600 text-4xl" />
    },
    {
        title: "Region Gənclərinin Yay Düşərgəsi",
        plan: "Gənclərin bir araya gəlib bilik və təcrübə qazandığı yay düşərgəsi.",
        about: "Təbiət qoynunda təşkil olunan düşərgə, interaktiv sessiyalar və komanda fəaliyyətləri ilə zəngindir.",
        icon: <FaCampground className="text-green-600 text-4xl" />
    },
    {
        title: "İnkişaf Akademiyası",
        plan: "Akademik və şəxsi bacarıqların inkişafı üçün nəzərdə tutulmuş uzunmüddətli tədris proqramı.",
        about: "Gənclərə təhsil, karyera və liderlik sahələrində inkişaf etməyə kömək edən xüsusi proqram.",
        icon: <FaUniversity className="text-blue-600 text-4xl" />
    }
];
const ProjectsTraining = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-gray-50">
            <h2 className="text-3xl font-bold mb-6">Layihələr</h2>
