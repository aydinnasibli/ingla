...
import { FaUsers, FaChalkboardTeacher, FaHandshake, FaTimes } from "react-icons/fa";
const trainings = [
    {
        title: "Komanda İdarəetməsi və Effektiv Kommunikasiya",
        plan: "Komanda ruhunun gücləndirilməsi, liderlik bacarıqları və effektiv ünsiyyət strategiyaları.",
        about: "Bu təlim işçi heyətinin daha səmərəli işləməsi və komanda işinin keyfiyyətini artırmaq üçün nəzərdə tutulub.",
        icon: <FaUsers className="text-blue-600 text-4xl" />
    },
    {
        title: "Daxili Motivasiya və Performansın Artırılması",
        plan: "İşçilərin daxili motivasiyasını artırmaq, performansı yüksəltmək və iş mühitini yaxşılaşdırmaq üçün metodlar.",
        about: "Məqsəd, işçilərin işlərinə daha həvəslə yanaşmasını təmin etmək və onların potensialını tam şəkildə ortaya çıxarmasına kömək etməkdir.",
        icon: <FaChalkboardTeacher className="text-green-600 text-4xl" />
    },
    {
        title: "Xidmət Mədəniyyəti və Müştəri Məmnuniyyəti",
        plan: "Müştəri yönümlü xidmətin inkişafı, effektiv ünsiyyət və müştəri məmnuniyyətini artırma strategiyaları.",
        about: "Bu təlim müştəri xidmətlərini gücləndirmək və uzunmüddətli müştəri münasibətləri qurmaq istəyən şirkətlər üçün uyğundur.",
        icon: <FaHandshake className="text-orange-600 text-4xl" />
    }

];

const CorporativeTraining = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-gray-50">
            <h2 className="text-3xl font-bold mb-6">Korporatif Təlimlər</h2>
...
export default CorporativeTraining;
