...
import { FaHandshake, FaUsers, FaTimes } from "react-icons/fa";
const trainings = [
    {
        title: "Loyallıq Proqramı",
        plan: "Müştərilərlə uzunmüddətli əlaqə yaratmaq və onların sadiqliyini artırmaq üçün strategiyalar.",
        about: "Bu proqram, müəssisələr üçün effektiv loyallıq sistemləri qurmağa kömək edir.",
        icon: <FaHandshake className="text-blue-600 text-4xl" />
    },
    {
        title: "Alumni Şəbəkəsi",
        plan: "Keçmiş məzunlarla əlaqə yaratmaq və onların qarşılıqlı dəstəyini təşviq etmək.",
        about: "Bu proqram, məzunlar arasında əməkdaşlığı və təcrübə paylaşımını gücləndirməyə yönəlib.",
...
const InglaClub = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-gray-50">
            <h2 className="text-3xl font-bold mb-6">Ingla Klub</h2>
