...
import { FaUserGraduate, FaLaptopCode, FaUsersCog, FaGavel, FaBrain, FaHandsHelping, FaTimes } from "react-icons/fa";
const trainings = [
    {
        title: "Karyera məsləhətçilərinin inkişaf kursu",
        plan: "Karyera məsləhətçiləri üçün strategiyalar, bacarıqlar və praktiki təlimlər.",
        about: "Bu kurs, karyera məsləhətçilərinin effektiv iş metodlarını öyrənməsi üçün nəzərdə tutulub.",
        icon: <FaUserGraduate className="text-green-600 text-4xl" />
    },
    {
        title: "Rəqəmsal məhsul sahibliyi kursu",
        plan: "Rəqəmsal məhsul idarəçiliyi və bazar analizi üzrə fundamental biliklər.",
        about: "İştirakçılar müasir rəqəmsal məhsul sahibliyi və strateji idarəetmə metodlarını öyrənəcəklər.",
        icon: <FaLaptopCode className="text-blue-600 text-4xl" />
    },
    {
        title: "İnsan resurslarının idarə olunması kursu",
        plan: "HR sahəsində müasir yanaşmalar, işə qəbul və performans idarəetməsi.",
        about: "İştirakçılar insan resurslarının effektiv idarə olunması üzrə biliklər əldə edəcəklər.",
        icon: <FaUsersCog className="text-red-600 text-4xl" />
    },
    {
        title: "Dövlət satınalmaları kursu",
        plan: "Dövlət satınalmaları prosesi, qanunvericilik və praktiki tətbiq.",
        about: "Bu kurs dövlət satınalmaları və tender prosesini daha yaxşı anlamaq istəyənlər üçündür.",
        icon: <FaGavel className="text-yellow-600 text-4xl" />
    },
    {
        title: "Psixoloji Konsultasiya prosesi kursu",
        plan: "Psixoloji konsultasiya və fərdi seansların idarə olunması üzrə biliklər.",
        about: "Psixoloji konsultasiya sahəsində praktiki bacarıqlar və metodlar öyrədilir.",
        icon: <FaBrain className="text-purple-600 text-4xl" />
    },
    {
        title: "Yeniyetmə və böyüklərlə psixoterapiya texnikaları kursu",
        plan: "Fərqli yaş qrupları üçün effektiv psixoterapiya yanaşmaları.",
        about: "Bu kurs psixoterapiyada istifadə edilən ən müasir texnikalar üzərində qurulub.",
...
const Courses = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-gray-50">
            <h2 className="text-3xl font-bold mb-6">İnkişaf Kursları</h2>
